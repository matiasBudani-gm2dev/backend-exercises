...
userRolesRouter.get("/",  authenticateToken, authorizeRoles(["admin"]), async(req, res, next)=>{
    try{
...
userRolesRouter.get("/:id",  authenticateToken, authorizeRoles(["admin"]), schemaReqValidation(roleIdSchema) ,async(req, res, next)=>{
    try{
...
userRolesRouter.get("/users/:id",  authenticateToken, authorizeRoles(["admin"]), async (req, res, next)=>{
    try{
...
userRolesRouter.get("/roles/:id", authenticateToken, authorizeRoles(["admin"]), async(req, res, next)=>{
    try{
        const id = Number(req.params.id)
...
userRolesRouter.post("/:id",  authenticateToken, authorizeRoles(["admin"]), schemaReqValidation(roleIdSchema) ,async(req, res, next)=>{
    try{
        const user_id = Number(req.params.id)
        const {role_id} = req.body
...
userRolesRouter.put("/:id",  authenticateToken, authorizeRoles(["admin"]), schemaReqValidation(rolesIdArraySchema) ,async (req, res, next)=>{
    try{
        const user_id = Number(req.params.id)
...
userRolesRouter.delete("/:id",  authenticateToken, authorizeRoles(["admin"]), async(req, res, next)=>{
    const user_id = Number(req.params.id)
